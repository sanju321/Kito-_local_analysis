...
class WorkerThread(Thread):
     ...
     def run(self):
        ...
        start_date_url=str(str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1])+'T'+str(time.asctime(time.localtime(time.time())).split(' ')[4]))
        end_date_url=str(str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1])+'T'+str(time.asctime(time.localtime(time.time())).split(' ')[4]))

        start_date_url=str(str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1])+'T00:00:00.100')
        end_date_url=str(str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1])+'T23:59:59.100')
        

        if str(self.project_to_download)=='System':
            f = open("./System/data_"+str(self.project_to_download)+"_"+str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1])+"_to_"+str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1])+".csv",'w')
            f_name="./System/data_"+str(self.project_to_download)+"_"+str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1])+"_to_"+str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1])+".csv"
        if str(self.project_to_download)=='Pcba':
            f = open("./Pcba/data_"+str(self.project_to_download)+"_"+str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1])+"_to_"+str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1])+".csv",'w')
            f_name="./Pcba/data_"+str(self.project_to_download)+"_"+str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1])+"_to_"+str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1])+".csv"
        if str(self.project_to_download)=='charger':
            f = open("./Charger/data_"+str(self.project_to_download)+"_"+str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1])+"_to_"+str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1])+".csv",'w')
            f_name="./Charger/data_"+str(self.project_to_download)+"_"+str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1])+"_to_"+str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1])+".csv"
                ...
                for d in dct:
                    try:
                        ...
                        if str(self.project_to_download)=='Pcba':
                            ...
                            strurl="https://kito.azoi.com//api/test-jig/v1/pcba_test_log/?pcba_test_log_id="+str(sid)
                        if str(self.project_to_download)=='charger':
...
class Pcba_win(wx.Panel):
    ...
    def __init__(self, parent,style = wx.SIMPLE_BORDER,size=(600,650),clearSigInt=True):
        ...
        self.start_date_combo_box = wx.ComboBox(self, -1,'-', pos=(220,10), size=(120, -1), choices=self.dates, style=wx.CB_READONLY)
        
        wx.StaticText(self, -1, 'End Date : ', (370, 10))
        self.end_date_combo_box = wx.ComboBox(self, -1,'-', pos=(450, 10), size=(120, -1), choices=self.dates, style=wx.CB_READONLY)

        wx.StaticText(self, -1, 'Total unique devices tested: ', (100, 50))
        self.total_unique_device_tested= wx.StaticText(self, -1, '', (400, 50))

        wx.StaticText(self, -1, 'First Pass : ', (100, 80))
        self.first_pass= wx.StaticText(self, -1, '', (400, 80))

        wx.StaticText(self, -1, 'Second Pass : ', (100, 110))
        self.second_pass= wx.StaticText(self, -1, '', (400, 110))

        wx.StaticText(self, -1, 'Third Pass : ', (100, 140))
        self.third_pass= wx.StaticText(self, -1, '', (400, 140))

        wx.StaticText(self, -1, 'Fourth Pass : ', (100, 170))
        self.fourth_pass= wx.StaticText(self, -1, '', (400, 170))

        wx.StaticText(self, -1, 'Other Pass : ', (100, 200))
        self.other_pass= wx.StaticText(self, -1, '', (400, 200))

        wx.StaticText(self, -1, 'Fail Device : ', (500, 230))
        self.fail_devices= wx.StaticText(self, -1, '', (800, 230))

        wx.StaticText(self, -1, 'Fail Cycle : ', (500, 260))
        self.total_failed_cycle= wx.StaticText(self, -1, '', (800, 260))

        wx.StaticText(self, -1, 'SG_Test : ', (530, 290))
        self.sg_test_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 290))

        wx.StaticText(self, -1, 'SD_Test : ', (530, 320))
        self.sd_test_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 320))

        wx.StaticText(self, -1, 'Charging_test : ', (530, 350))
        self.charging_test_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 350))

        wx.StaticText(self, -1, 'blue_led : ', (530, 380))
        self.blue_led_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 380))

        wx.StaticText(self, -1, 'blink_led : ', (530, 410))
        self.blink_led_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 410))

        wx.StaticText(self, -1, 'white_led : ', (530, 440))
        self.white_led_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 440))




        wx.StaticText(self, -1, 'Retested Devices : ', (100, 230))
        self.retest_devices= wx.StaticText(self, -1, '', (400, 230))

        wx.StaticText(self, -1, 'Fail Cycle : ', (100, 260))
        self.total_fail_cycle= wx.StaticText(self, -1, '', (400, 260))

        wx.StaticText(self, -1, 'SG_Test : ', (130, 290))
        self.sg_test_fail_cycle= wx.StaticText(self, -1, '', (400, 290))

        wx.StaticText(self, -1, 'SD_Test : ', (130, 320))
        self.sd_test_fail_cycle= wx.StaticText(self, -1, '', (400, 320))

        wx.StaticText(self, -1, 'Charging_test : ', (130, 350))
        self.charging_test_fail_cycle= wx.StaticText(self, -1, '', (400, 350))

        wx.StaticText(self, -1, 'blue_led : ', (130, 380))
        self.blue_led_fail_cycle= wx.StaticText(self, -1, '', (400, 380))

        wx.StaticText(self, -1, 'blink_led : ', (130, 410))
        self.blink_led_fail_cycle= wx.StaticText(self, -1, '', (400, 410))

        wx.StaticText(self, -1, 'white_led : ', (130, 440))
        self.white_led_fail_cycle= wx.StaticText(self, -1, '', (400, 440))
    ...
    def analyze_btn_click(self,event):
        ...
        self.all_dev_dict = { 'dev_addr' : [],'tested_count':[],'overall_res':[],'blue_led_fail':[],'blink_led_fail':[],'white_led_fail':[],'sd_test_fail':[],
        'charging_test_fail':[],'sg_test_fail':[]}
        ...
        for key in sorted(self.final_analysis.keys()):
            ...
            if self.final_analysis[key]['Charging_test'] == 'fail' or self.final_analysis[key]['Charging_test'] ==  'Fail':
        ...
        for i in range(len(self.all_dev_dict['dev_addr'])):
            if self.all_dev_dict['dev_addr'][i] not in self.dev_dict['dev_addr']:
        ...
        for i in range(len(self.all_dev_dict['overall_res'])):
            if self.all_dev_dict['tested_count'][i]==1 and (self.all_dev_dict['overall_res'][i]=='Fail' or  self.all_dev_dict['overall_res'][i]=='fail'):
                #print self.all_dev_dict['overall_res'][i]+'  :   '+str(self.all_dev_dict['tested_count'][i])
                f_cnt+=1
            ...
            if self.all_dev_dict['tested_count'][i]==2 and self.all_dev_dict['overall_res'][i]=='Pass':
                self.second_pass_counter+=1
            if self.all_dev_dict['tested_count'][i]==2 and (self.all_dev_dict['overall_res'][i]=='Fail' or self.all_dev_dict['overall_res'][i]=='fail'):
                #print self.all_dev_dict['overall_res'][i]+'  :   '+str(self.all_dev_dict['tested_count'][i])
                f_cnt+=1
                if self.all_dev_dict['blue_led_fail'][i]=='fail':
                    self.failed_blue_led_fail_count+=1
            ...
            if self.all_dev_dict['tested_count'][i]==3 and self.all_dev_dict['overall_res'][i]=='Pass':
                self.third_pass_counter+=1
            if self.all_dev_dict['tested_count'][i]==3 and (self.all_dev_dict['overall_res'][i]=='Fail' or self.all_dev_dict['overall_res'][i]=='fail'):
                #print self.all_dev_dict['overall_res'][i]+'  :   '+str(self.all_dev_dict['tested_count'][i])
                f_cnt+=1
                if self.all_dev_dict['blue_led_fail'][i]=='fail':
                    self.failed_blue_led_fail_count+=1
            ...
            if self.all_dev_dict['tested_count'][i]==4 and self.all_dev_dict['overall_res'][i]=="Pass":
                self.fourth_pass_counter+=1
            if self.all_dev_dict['tested_count'][i]==4 and (self.all_dev_dict['overall_res'][i]=='Fail' or self.all_dev_dict['overall_res'][i]=='fail'):
                #print self.all_dev_dict['overall_res'][i]+'  :   '+str(self.all_dev_dict['tested_count'][i])
                f_cnt+=1
                if self.all_dev_dict['blue_led_fail'][i]=='fail':
                    self.failed_blue_led_fail_count+=1
        ...
        self.total_fail_cycle.SetLabel(str(self.blue_led_fail_cycle_counter+self.blink_led_fail_cycle_counter+self.white_led_fail_cycle_counter
        ...
        self.total_failed_cycle.SetLabel(str(self.failed_blue_led_fail_count+self.failed_blink_led_fail_count+self.failed_white_led_fail_count+self.failed_charging_test_fail_count
...
class Sync_win(wx.Panel):
    ...
    def __init__(self, parent,style = wx.SIMPLE_BORDER,size=(500,500),clearSigInt=True):
        ...
        wx.StaticText(self, -1, 'Fail Device : ', (100, 230))
        self.fail_devices= wx.StaticText(self, -1, '', (400, 230))

        wx.StaticText(self, -1, 'Retested Devices : ', (100, 260))
        self.retest_devices= wx.StaticText(self, -1, '', (400, 260))
...
class Download_win(wx.Panel):
    ...
    def __init__(self, parent,style = wx.SIMPLE_BORDER,size=(500,500),clearSigInt=True):
        ...
        self.project_Combo_Box = wx.ComboBox(self,-1, project_Options[0],pos=(250, 30), choices=project_Options,style=wx.CB_READONLY)
    ...
    def download_btn_click(self,evt):
        ...
        if download_start_date=='' or download_end_date=='':
            dlg = wx.MessageDialog(self, "Please select start and end date For Downloading", 'Info', wx.OK | wx.ICON_INFORMATION)
            dlg.ShowModal()
            dlg.Destroy()
            self.download_btn.Enable(True)
        else:
            ...
            if self.download_is_greater(download_start_date,download_end_date) :
                dlg = wx.MessageDialog(self, "Please Select valid start and end Date", 'Info', wx.OK | wx.ICON_INFORMATION)
                dlg.ShowModal()
                dlg.Destroy()
                self.download_btn.Enable(True)
    ...
    def OnResult(self, event):
         ...
         if event.data is None:
             ...
             dlg = wx.MessageDialog(self, "Data not Found ,Please select Date again ", 'Info', wx.OK | wx.ICON_INFORMATION)
             dlg.ShowModal()
             dlg.Destroy()
             self.download_btn.Enable(True)
             ...
             #self.status.SetLabel('Computation Result: %s' % event.data)
                 ...
                 if event.data2==True:
                     self.download_btn.Enable(True)
                     download_start_date_url=str(str(self.start_date_list[2])[:4]+'-'+str(self.start_date_list[0])+'-'+str(self.start_date_list[1]))
                     download_end_date_url=str(str(self.end_date_list[2])[:4]+'-'+str(self.end_date_list[0])+'-'+str(self.end_date_list[1]))

                     dlg = wx.MessageDialog(self,"File name is "+ "data_"+str(self.project_to_download)+"_"+download_start_date_url +" to "+download_end_date_url+".csv", 'Download Completed', wx.OK | wx.ICON_INFORMATION)
                     dlg.ShowModal()
                     dlg.Destroy()
...
class AnalysisPanel(wx.Panel):
    def __init__(self, parent,style = wx.SIMPLE_BORDER,size=(500,500),clearSigInt=True):
        ...
        self.data_combo_box = wx.ComboBox(self, -1,'-', pos=(620,10), size=(120, -1), choices=self.data_diff, style=wx.CB_READONLY)
        self.Bind(wx.EVT_BUTTON, self.analyze_btn_click,self.analyze_btn)
        ...
        wx.StaticText(self, -1, 'ecg : ', (530, 290))
        self.ecg_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 290))

        wx.StaticText(self, -1, 'spo2 : ', (530, 320))
        self.spo2_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 320))

        wx.StaticText(self, -1, 'temperature : ', (530, 350))
        self.temp_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 350))

        wx.StaticText(self, -1, 'fuel gauge : ', (530, 380))
        self.fuel_gauge_fail_in_failed_cycle= wx.StaticText(self, -1, '', (800, 380))

        wx.StaticText(self, -1, 'Battery level-[0 %] : ', (100, 230))
        self.battery_level_0= wx.StaticText(self, -1, '', (400, 230))

        wx.StaticText(self, -1, 'Retested Devices : ', (100, 260))
        self.retest_devices= wx.StaticText(self, -1, '', (400, 260))

        wx.StaticText(self, -1, 'Fail Cycle : ', (100, 290))
        self.total_fail_cycle= wx.StaticText(self, -1, '', (400, 290))

        wx.StaticText(self, -1, 'ecg : ', (130, 320))
        self.ecg_fail_cycle= wx.StaticText(self, -1, '', (400, 320))

        wx.StaticText(self, -1, 'spo2 : ', (130, 350))
        self.spo2_fail_cycle= wx.StaticText(self, -1, '', (400, 350))

        wx.StaticText(self, -1, 'temperature : ', (130, 380))
        self.temp_fail_cycle= wx.StaticText(self, -1, '', (400, 380))

        wx.StaticText(self, -1, 'fuel gauge : ', (130, 410))
        self.fuel_gauge_fail_cycle= wx.StaticText(self, -1, '', (400, 410))
    ...
    def charger_pcba_btn_click(self,evet):
        ...
        frame = wx.Frame(None,title="Charger Analysis",pos=findScreenCenter(500,500), size=(750,500))
    ...
    def analyze_btn_click(self,event):
        ...
        #print self.final_analysis
        self.all_dev_dict = { 'dev_addr' : [],'tested_count':[],'overall_res':[],'ecg_fail':[],'spo2_fail':[],'temp_fail':[],'fuel_gauge_fail':[]}
        self.dev_dict={'dev_addr':[]}
        ...
        self.total_fail_cycle.SetLabel(str(self.ecg_fail_cycle_counter+self.spo2_fail_cycle_counter+self.temp_fail_cycle_counter+self.fuel_gauge_fail_cycle_counter))
        self.total_unique_device_tested.SetLabel(str(len(self.all_dev_dict['dev_addr'])))
        ...
        self.total_failed_cycle.SetLabel(str(self.failed_ecg_fail_count+self.failed_spo2_fail_count+self.failed_temp_fail_count+self.failed_fuelgauge_fail_count))
